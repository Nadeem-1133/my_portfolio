                ...
                <form className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        required
                        className="w-full bg-slate-800/50 border border-white/5 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-indigo-500 transition-all"
                  ...
                  <div className="space-y-2">
                    ...
                    <textarea
                      ...
                      required
                      rows="5"
                      className="w-full bg-slate-800/50 border border-white/5 rounded-2xl px-6 py-4 text-white focus:outline-none focus:border-indigo-500 transition-all resize-none"
                  ...
                  <div className="flex flex-col sm:flex-row gap-4">
                    <button
                      ...
                      className="flex-1 bg-[#25D366] hover:scale-[1.02] active:scale-95 text-white font-black py-5 rounded-2xl transition-all shadow-[0_10px_30px_rgba(37,211,102,0.3)] flex items-center justify-center gap-3 group"
                    >
                    ...
                    <button
                      ...
                      onClick={handleEmail}
                      disabled={isSending}
                      className="flex-1 bg-gradient-to-r from-indigo-500 to-purple-600 hover:scale-[1.02] active:scale-95 text-white font-black py-5 rounded-2xl transition-all shadow-[0_10px_30px_rgba(99,102,241,0.3)] disabled:opacity-50 flex items-center justify-center gap-3 group"
                    >
                      <svg className="w-6 h-6 group-hover:-translate-y-1 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
